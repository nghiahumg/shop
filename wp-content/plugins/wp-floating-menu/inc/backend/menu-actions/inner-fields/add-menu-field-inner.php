                ...
                <div class="wpfm-list-inner-content">
                    ...
                    <p class="button-controls wp-clearfix">
                        ...
                        <span class="wpfm-add-to-menu">
                            <input disabled="disabled" type="button" field-data="<?php echo esc_attr('Custom Link','wp-floating-menu');?>" submit-field-val="2" class="button-secondary wpfm-submit-add-to-menu"  id="wpfm-submit-posttype-custom-link" value="Add to Menu" name="wpfm_add_post_type_custom_link"/>
                        </span>                
                    </p>
                </div>
