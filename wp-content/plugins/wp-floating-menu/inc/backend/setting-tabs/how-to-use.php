                    ...
                    <div class="about-desc-wrap clearfix">
                        <div class="about-content">           
                            <div class="about-title-content">
                                <div class="wpfm-title"><span class="wpfm-tips-icon"><i class="fa fa-info-circle" aria-hidden="true"></i></span><span class="wpfm-how-section-title"><?php _e('Helpful Tips', 'wp-floating-menu'); ?></span></div>
